...
<!-- Mirrored from cartzilla.createx.studio/account-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:10 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->

<head>
    <meta charset="utf-8">
    <title>Cartzilla | Profile info</title>
    <!-- SEO Meta Tags-->
        ...
        <header class="shadow-sm">
            ...
            <div class="navbar-sticky bg-light">
                <div class="navbar navbar-expand-lg navbar-light">
                    <div class="container"><a class="navbar-brand d-none d-sm-block me-3 flex-shrink-0" href="index.php"><img src="img/about/logo.png" width="100" alt="Infinite slot"></a><a class="navbar-brand d-sm-none me-2" href="index.php"><img src="img/about/logo.png" width="74" alt="Infinite slot"></a>
                        <!-- Search-->
            ...
            <div class="row">
                    ...
                    <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
                        <div class="d-md-flex justify-content-between align-items-center text-center text-md-start p-4">
                            <div class="d-md-flex align-items-center">
                                <div class="img-thumbnail rounded-circle position-relative flex-shrink-0 mx-auto mb-2 mx-md-0 mb-md-0" style="width: 6.375rem;"><span class="badge bg-warning position-absolute end-0 mt-n2" data-bs-toggle="tooltip" title="Reward points">384</span><img class="rounded-circle" src="./img/nft/home/01.jpg" alt="Profile Image" id="profile-image-top"></div>
                                <div class="ps-md-3">
                                    <h3 class="fs-base mb-0" id="profile-fullname"></h3><span class="text-accent fs-sm" id="profile-email"></span>
                                </div>
                        ...
                        <div class="d-lg-block collapse" id="account-menu">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-orders.php"><i class="ci-bag opacity-60 me-2"></i>Orders<span class="fs-sm text-muted ms-auto" id="account-order-count">0</span></a></li>
                                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-wishlist.php"><i class="ci-heart opacity-60 me-2"></i>Wishlist<span class="fs-sm text-muted ms-auto" id="account-wishlist-count">0</span></a></li>
                                <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-tickets.php"><i class="ci-help opacity-60 me-2"></i>Support tickets<span class="fs-sm text-muted ms-auto" id="account-support-count">0</span></a></li>
                            </ul>
                            <div class="bg-secondary px-4 py-3">
                                <h3 class="fs-sm mb-0 text-muted">Account settings</h3>
                            </div>
                            <ul class="list-unstyled mb-0">
                                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-profile.php"><i class="ci-user opacity-60 me-2"></i>Profile info</a></li>
                                ...
                                <li class="d-lg-none border-top mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 btn_logout" href="#"><i class="ci-sign-out opacity-60 me-2"></i>Sign out</a></li>
                            </ul>
                        </div>
                    </div>
                </aside>
                ...
                <section class="col-lg-8">
                    ...
                    <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3">
                        <h6 class="fs-base text-light mb-0">Update you profile details below:</h6><a class="btn btn-primary btn-sm btn_logout" href="#"><i class="ci-sign-out me-2"></i>Sign out</a>
                    </div>
                    <!-- Profile form-->
                    <form>
                        <div class="bg-secondary rounded-3 p-4 mb-4">
                            <div class="d-flex align-items-center"><img class="rounded" src="" width="90" alt="Profile Picture" id="profile-image">
                                <div class="ps-3">
                        ...
                        <div class="row gx-4 gy-3">
                            <div class="col-sm-12">
                                ...
                                <input class="form-control account-fullname" name="name" type="text" id="account-fullname" value="">
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="password-toggle">
                                    ...
                                    <label class="password-toggle-btn" aria-label="Show/hide password">
                                        <input class="password-toggle-check" type="checkbox" id="update-profile-password"><span class="password-toggle-indicator"></span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    ...
                                    <button class="btn btn-primary mt-3 mt-sm-0" type="button" id="update-profile">Update profile</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row">
                ...
                <aside class="col-lg-4 pt-4 pt-lg-0 pe-xl-5">
                    <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
                        <div class="d-md-flex justify-content-between align-items-center text-center text-md-start p-4">
                            <div class="d-md-flex align-items-center">
                                <div class="img-thumbnail rounded-circle position-relative flex-shrink-0 mx-auto mb-2 mx-md-0 mb-md-0" style="width: 6.375rem;"><span class="badge bg-warning position-absolute end-0 mt-n2" data-bs-toggle="tooltip" title="Reward points">384</span><img class="rounded-circle" src="" alt="Profile Image" id="profile-image-top"></div>
                                <div class="ps-md-3">
                                    <h3 class="fs-base mb-0" id="profile-fullname"></h3><span class="text-accent fs-sm" id="profile-email"></span>
                                </div>
                            </div><a class="btn btn-primary d-lg-none mb-2 mt-3 mt-md-0" href="#account-menu" data-bs-toggle="collapse" aria-expanded="false"><i class="ci-menu me-2"></i>Account menu</a>
                        ...
                        <div class="d-lg-block collapse" id="account-menu">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-orders.html"><i class="ci-bag opacity-60 me-2"></i>Orders<span class="fs-sm text-muted ms-auto" id="account-order-count">0</span></a></li>
                                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-wishlist.php"><i class="ci-heart opacity-60 me-2"></i>Wishlist<span class="fs-sm text-muted ms-auto" id="account-wishlist-count">0</span></a></li>
                                <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-tickets.html"><i class="ci-help opacity-60 me-2"></i>Support tickets<span class="fs-sm text-muted ms-auto" id="account-support-count">0</span></a></li>
                            </ul>
                            <div class="bg-secondary px-4 py-3">
                                <h3 class="fs-sm mb-0 text-muted">Account settings</h3>
                            </div>
                ...
                <section class="col-lg-8">
                    ...
                    <form>
                        ...
                        <div class="row gx-4 gy-3">
                            <div class="col-sm-12">
                                <label class="form-label" for="account-fn">Full Name</label>
                                <input class="form-control account-fullname" type="text" id="account-fullname" value="">
                            </div>
