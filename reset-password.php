...
if(isset($_SESSION['user_id'])) {
    header("Location: index.php"); // Redirect to index.php or any other desired page
          ...
          <div class="modal-body tab-content py-4">
            ...
            <form class="needs-validation tab-pane fade" autocomplete="off" novalidate id="form_register">
              <div class="mb-3">
                ...
                <input class="form-control" type="text" placeholder="John Doe" required id="reg_fn">
                <div class="invalid-feedback">Please fill in your name.</div>
              </div>
              <div class="mb-3">
                <label for="su-email">Email address</label>
                <input class="form-control" type="email" placeholder="johndoe@example.com" required id="reg_email">
                <div class="invalid-feedback">Please provide a valid email address.</div>
              </div>
              <div class="mb-3">
                <label class="form-label" for="su-password">Password</label>
                <div class="password-toggle">
                  <input class="form-control" type="password" required id="reg_password" required>
                  <label class="password-toggle-btn" aria-label="Show/hide password">
                    <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                  </label>
                </div>
              ...
              <div class="mb-3">
                ...
                <div class="password-toggle">
                  <input class="form-control" type="password" d="reg_password_confirm" required>
                  <label class="password-toggle-btn" aria-label="Show/hide password">
                    <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                  </label>
                </div>
              </div>
              <button class="btn btn-primary btn-shadow d-block w-100" type="submit" id="btn_reg">Sign up</button>
            </form>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-10">
            ...
            <div class="card py-2 mt-4">
              <form class="card-body needs-validation" id="form_reset" novalidate>
              <div class="mb-3">
              <label class="form-label" for="recover_password">New Password</label>
              <div class="password-toggle">
                <input class="form-control" type="password" id="recover_password" required>
                <label class="password-toggle-btn" aria-label="Show/hide password">
            ...
            <div class="mb-3">
              ...
              <div class="password-toggle">
                ...
                <button class="btn btn-primary" type="submit" id="btn_reset">Change password</button>
              </form>
            </div>
          </div>
        </div>
        ...
        $(document).ready(function() {
          // sweetAlert
            ...
            $("#form_reset").submit(function(e) {
              e.preventDefault();
                var p1 = $("#recover_password").val();
                var p2 = $("#confirm_password").val();
                var otpcode = <?php echo $_GET['verification']; ?>;
                var delay = 2000;
                if (p1 == "" || p2 == "") {
                  ...
                  title: "Error Message",
                  icon: "warning",
                  text: 'Sorry, the two passwords are not the same'
                  });
                }
                else {
                  $.ajax({
                    url: "includes/reset_password_script.php",
                    method: "POST",
                    dataType: "json",
                    data: {
                      p1: p1,
                    ...
                    beforeSend: function(){
                      ...
                      $("#btn_reset").html('<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span> Loading...');
                    },
