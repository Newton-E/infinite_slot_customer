...
<!-- Mirrored from cartzilla.createx.studio/account-tickets.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:11 GMT -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button class="btn btn-secondary submit-ticket-close" type="button" data-bs-dismiss="modal">Close</button>
              <button class="btn btn-primary submit-ticket" type="submit">Submit Ticket</button>
            </div>
          </div>
        </div>
      </form>
          ...
          <section class="col-lg-8">
            ...
            <div class="table-responsive fs-md mb-4">
              <table class="table table-hover mb-0">
                ...
                <tbody class="support-ticket-content">
