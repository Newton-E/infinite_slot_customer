...
if (!empty($_SESSION["user_id"])) {
    ...
    foreach ($result as $row) {
        ...
        <div class="d-sm-flex justify-content-between my-4 pb-3 border-bottom">
              <div class="d-sm-flex text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.php"><img src="../retailers_admin/assets/img/products/' . $image_preview . '" width="160" alt="Product"></a>
                <div class="pt-2">
                  <h3 class="product-title fs-base mb-2"><a href="shop-single.php?product='.$row['prodcode'].'">' . substr($row["name"], 0, 25) . '...</a></h3>
                  ...
                  <div class="fs-lg text-accent pt-2">₦' . number_format($row["cost_price"]*$row["qty"], 2) . '</div>
                </div>
              </div>
              <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-end" style="max-width: 9rem;">
                <p class="mb-0"><span class="text-muted fs-sm">Quantity:</span><span>&nbsp;' . $row["qty"] . '</span></p>
                <button class="btn btn-link px-0" type="button" disabled="disabled" title="You cannot edit here" id="'.$row['prodcode'].'"><i class="ci-edit me-2"></i><span class="fs-sm">Edit</span></button>
              </div>
            </div>
        ';
            ...
            <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                <div class="d-block d-sm-flex align-items-center text-center text-sm-start">
                    ...
                    <div class="pt-2">
                        ...
                        <div class="fs-lg text-accent pt-2">₦' . number_format($product_price, 2) . '<small>00</small></div>
                    </div>
                </div>
                <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start" style="max-width: 9rem;">
                    <label class="form-label" for="quantity1">Quantity</label>
                    <input class="form-control" type="number" id="quantity1_' . $product_id . '" min="1" value="' . $quantity . '">
