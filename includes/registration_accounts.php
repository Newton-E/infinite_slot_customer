...
if (isset($_POST['user_email'])) {
    ...
    if ($count > 0) {
        ...
        $insertSQL = $con->prepare("INSERT INTO tb_users (userid, fullname, address, email, phone,password) VALUES(:user_id, :fullname,:address,:email,:phone,:password)");
        $params = array(
            ':user_id' => $randCode,
                ...
                if ($existingOrder) {
                    ...
                    if ($product) {
                        ...
                        $stmt->execute([
                            ...
                            ':pay_status' => 0,
                            // Set the appropriate payment status value
