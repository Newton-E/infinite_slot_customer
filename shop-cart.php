<?php require_once('./includes/verify_login.php');?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="utf-8">
    <title>Infinite Shopping | Shop Cart</title>
    <!-- SEO Meta Tags-->
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body tab-content py-4">
            <form class="needs-validation tab-pane fade show active" id="login-form" autocomplete="off" novalidate id="signin-tab">
              <div class="mb-3">
        ...
        <div class="topbar topbar-dark bg-primary">
          <div class="container">
            ...
            <div class="topbar-text text-nowrap d-none d-md-inline-block"><i class="ci-support"></i><span class="text-muted me-1">Support</span><a class="topbar-link" href="tel:00331697720">(00) 33 169 7720</a></div>
              <div class="topbar-text dropdown disable-autohide"><a class="topbar-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><img class="me-2" src="img/flags/ng.png" width="20" alt="English">Nig / ₦</a>
            ...
            <div class="d-none d-md-block ms-3 text-nowrap"><a class="topbar-link d-none d-md-inline-block" href="account-wishlist.php"><i class="ci-heart mt-n1"></i>Wishlist (3)</a><a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="comparison.php"><i class="ci-compare mt-n1"></i>Compare (3)</a><a class="topbar-link ms-3 border-start border-light ps-3 d-none d-md-inline-block" href="order-tracking.php"><i class="ci-location mt-n1"></i>Order tracking</a></div>
          </div>
        </div>
          ...
          <div class="navbar navbar-expand-lg navbar-light navbar-stuck-menu mt-n2 pt-0 pb-2">
            <div class="container">
              <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <!-- Primary menu-->
                <ul class="navbar-nav">
                  <li class="nav-item"><a class="nav-link" href="../retailers/index.php">Become a vendor</a>
                  </li>
                  <li class="nav-item active"><a class="nav-link" href="shop.php">Shop</a></li>
                  <li class="nav-item"><a class="nav-link" href="help-topics.php">Help Center</a></li>
        ...
        <div class="row">
          ...
          <section class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center pt-3 pb-4 pb-sm-5 mt-1">
              <h2 class="h6 text-light mb-0">Products</h2><a class="btn btn-outline-light btn-sm ps-2" href="shop.php"><i class="ci-arrow-left me-2"></i>Continue shopping</a>
            </div>
            <form action="" id="update_cart">
            <!-- Item-->
            <div id="shop-cart-items"></div>
            
            <div class="cart_list_filter" id="cart_list_filter"></div>
            ...
            <div class="bg-white rounded-3 shadow-lg p-4">
              <div class="py-2 px-xl-4">
                <div class="text-center mb-4 pb-3 border-bottom">
                  ...
                  <h3 class="fw-normal cart_list_price"></h3>
                  <span class="text-decoration-line-through text-danger d-none" id="discount_price"></span>
                ...
                <div class="accordion" id="order-options">
                  <div class="accordion-item">
                    ...
                    <div class="accordion-collapse collapse show" id="promo-code" data-bs-parent="#order-options">
                      <form class="accordion-body needs-validation" method="post" id="form_promo" novalidate>
                        <div class="mb-3">
                          <input class="form-control" type="text" placeholder="Promo code" id="promoCode" required>
                          <div class="invalid-feedback">Please provide promo code.</div>
                        </div>
                        <button class="btn btn-outline-primary d-block w-100" id="btn_promo" type="submit">Apply promo code</button>
                      </form>
                    </div>
                  </div>
                </div><a class="btn btn-primary btn-shadow d-block w-100 mt-4" href="checkout-details.php"><i class="ci-card fs-lg me-2"></i>Proceed to Checkout</a>
              </div>
            </div>
          </aside>
        </div>
