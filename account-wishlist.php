...
<!-- Mirrored from cartzilla.createx.studio/account-wishlist.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:11 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Infinite slot shopping</title>
    <!-- SEO Meta Tags-->
            ...
            <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
                ...
                <div class="d-lg-block collapse" id="account-menu">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-orders.php"><i class="ci-bag opacity-60 me-2"></i>Orders<span class="fs-sm text-muted ms-auto cart_count" id="account-order-count">0</span></a></li>
                        <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-wishlist.php"><i class="ci-heart opacity-60 me-2"></i>Wishlist<span class="fs-sm text-muted ms-auto account-wishlist-count"></span></a></li>
                        <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="account-tickets.html"><i class="ci-help opacity-60 me-2"></i>Support tickets<span class="fs-sm text-muted ms-auto account-support-count">0</span></a></li>
                    </ul>
                    <div class="bg-secondary px-4 py-3">
