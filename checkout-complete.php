...
<!-- Mirrored from cartzilla.createx.studio/checkout-complete.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:09 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Infinite Shopping | Checkout Complete</title>
    <!-- SEO Meta Tags-->
  ...
  <body class="handheld-toolbar-enabled">
    ...
    <main class="page-wrapper">
      ...
      <header class="shadow-sm">
        <!-- Topbar-->
        <div class="topbar topbar-primary bg-primary">
          <div class="container">
        ...
        <div class="navbar-sticky bg-light">
          <div class="navbar navbar-expand-lg navbar-light">
            <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="index.html"><img src="img/about/logo.png" width="100" alt="Infinite slot"></a><a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="index.html"><img src="img/about/logo.png" width="74" alt="Infinite slot"></a>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="docs/changelog.html">
                          <div class="d-flex">
                            ...
                            <div class="ms-2"><span class="d-block text-heading">Changelog<span class="badge bg-success ms-2">v2.5.0</span></span><small class="d-block text-muted">Regular updates</small></div>
                          </div></a></li>
                      <li class="dropdown-divider"></li>
