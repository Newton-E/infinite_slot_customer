...
<!-- Mirrored from cartzilla.createx.studio/home-electronics-store.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:39:53 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Infinite Slot | Home page</title>
    <!-- SEO Meta Tags-->
    <meta name="description" content="Infinite Shopping - Bootstrap E-commerce Template">
    ...
    <link rel="stylesheet" media="screen" href="vendor/lightgallery.js/dist/css/lightgallery.min.html"/>
    <link rel="stylesheet" type="text/css" href="js/sweat/sweetalert2.min.css">
...
})(window,document,'script','dataLayer','GTM-5BVPCMZ');</script>
  </head>
  <!-- Body-->
  <body class="handheld-toolbar-enabled">
    <!-- Google Tag Manager (noscript)-->
    <noscript>
      <iframe src="http://www.googletagmanager.com/ns.html?id=GTM-5BVPCMZ" height="0" width="0" style="display: none; visibility: hidden;"></iframe>
    </noscript>
        ...
        <div class="modal-content">
          <div class="modal-header bg-secondary">
            <ul class="nav nav-tabs card-header-tabs" role="tablist">
              <li class="nav-item"><a class="nav-link fw-medium active" href="#login_form" data-bs-toggle="tab" role="tab" aria-selected="true"><i class="ci-unlocked me-2 mt-n1"></i>Sign in</a></li>
              <li class="nav-item"><a class="nav-link fw-medium" href="#form_register" data-bs-toggle="tab" role="tab" aria-selected="false"><i class="ci-user me-2 mt-n1"></i>Sign up</a></li>
            </ul>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body tab-content py-4">
            <form class="needs-validation tab-pane fade show active" id="login_form" autocomplete="off" novalidate>
              <div class="mb-3">
                <label class="form-label" for="user_email">Email address</label>
                <input class="form-control" type="email" id="user_email" name="user_email" placeholder="johndoe@example.com" required>
              ...
              <div class="mb-3 d-flex flex-wrap justify-content-between">
                ...
                </div><a class="fs-sm" href="account-password-recovery.php">Forgot password?</a>
              </div>
              <button class="btn btn-primary btn-shadow d-block w-100" type="submit">Sign in</button>
            </form>
            <form class="needs-validation tab-pane fade" autocomplete="off" novalidate id="form_register">
              <div class="mb-3">
                <label class="form-label" for="reg_fn">Full name</label>
                <input class="form-control" type="text" id="reg_fn" placeholder="John Doe" required>
                <div class="invalid-feedback">Please fill in your name.</div>
              </div>
              <div class="mb-3">
                <label for="su-phone">Phone</label>
                <input class="form-control" type="tel" id="reg_phone" placeholder="08169895827" required>
                <div class="invalid-feedback">Please provide a phone Number.</div>
              </div>
              <div class="mb-3">
                <label for="su-email">Email address</label>
                <input class="form-control" type="email" id="reg_email" placeholder="johndoe@example.com" required>
                <div class="invalid-feedback">Please provide a valid email address.</div>
              </div>
              <div class="mb-3">
                <label for="reg_address">Address</label>
                <input class="form-control" type="text" id="reg_address" placeholder="Address" required>
                <div class="invalid-feedback">Please provide a valid address.</div>
              </div>
              <div class="mb-3">
                <label class="form-label" for="reg_password">Password</label>
                <div class="password-toggle">
                  <input class="form-control" type="password" id="reg_password" required>
                  <label class="password-toggle-btn" aria-label="Show/hide password">
                    <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                  </label>
                </div>
              ...
              <div class="mb-3">
                ...
                <div class="password-toggle">
                  <input class="form-control" type="password" id="reg_password_confirm" required>
                  <label class="password-toggle-btn" aria-label="Show/hide password">
                    <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                  </label>
                </div>
    ...
    <div class="modal fade" id="compare-modal" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header bg-secondary">
            <span class="header-text">Compare products</span>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body tab-content py-4">
            <form action="#" id="compare-form">
            <div class="first-produ">
              <input type="hidden" id="first-product-id">
              <input type="hidden" id="first-product-category">
              <div class="card col-md-3">
              <span class="badge bg-success position-absolute end-0 mt-n2" data-bs-toggle="tooltip" data-bs-original-title="Reward points">Selected</span>
              <img class="card-img-top compared_product_img" src="..." alt="Card image cap">
              <div class="card-body">
              <a class="product-meta d-block fs-xs pb-1" id="compare-category" href="#"></a>
              <h3 class="product-title fs-sm"><a href="shop-single.php?product=639775" class="compared_product_name"></a></h3>
              <div class="d-flex justify-content-between">
                <div class="product-price"><span class="text-accent compare_prod_ammount"><small>00</small></span></div>
            ...
            <div class="compare_other_product py-2">
              <h4>Chose a product to compare</h4>
              <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3" id="compare_products"></div>
            </div>
            <button class="btn btn-primary btn-shadow d-block w-100 py-3">Compare</button>
            </form>
          </div>
        </div>
      </div>
    ...
    <main class="page-wrapper">
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title product-title"><a href="shop-single-v2.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Go to product page" id="productName"><i class="ci-arrow-right fs-lg ms-2"></i></a><input type="hidden" id="productid"/></h4>
              <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-7 pe-lg-0">
                  <div class="product-gallery">
                    <div class="product-gallery-preview order-sm-2" id="product_item_img">
                    </div>
                    <div class="product-gallery-thumblist order-sm-1" id="prod_img_children">
                      <!-- <a class="product-gallery-thumblist-item active" href="#first"><img src="img/shop/single/gallery/th05.jpg" alt="Product thumb"></a>
                    <a class="product-gallery-thumblist-item" href="#second"><img src="img/shop/single/gallery/th06.jpg" alt="Product thumb"></a>
                    <a class="product-gallery-thumblist-item" href="#third"><img src="img/shop/single/gallery/th07.jpg" alt="Product thumb"></a>
                    <a class="product-gallery-thumblist-item" href="#fourth"><img src="img/shop/single/gallery/th08.jpg" alt="Product thumb"></a> -->
                  </div>
                  </div>
                </div>
                <!-- Product details-->
                <div class="col-lg-5 pt-4 pt-lg-0 image-zoom-pane">
                  <div class="product-details ms-auto pb-3">
                    ...
                    <div class="h3 fw-normal text-accent mb-3 me-1 quick-view-price"></div>
                    <div class="position-relative me-n4 mb-3">
                      <div class="product-badge product-available mt-n1"><i class="ci-security-check"></i>Product available</div>
                    </div>
                    <div class="d-flex align-items-center pt-2 pb-4">
                      <input type="number" class="form-control m-3 preview-product-qty" id="" value="1" style="width: 5rem;">
                      <button class="btn btn-primary btn-shadow d-block w-100 btn_add_cart" id="" type="button"><i class="ci-cart fs-lg me-2"></i>Add to Cart</button>
                    </div>
                    <div class="d-flex mb-4">
                      <div class="w-100 me-3">
                        <button class="btn btn-secondary d-block w-100 btn_add_wishlist_preview" id="" type="button"><i class="ci-heart fs-lg me-2"></i><span class='d-none d-sm-inline'>Add to </span>Wishlist</button>
                      </div>
                      <div class="w-100">
                        <button class="btn btn-secondary d-block w-100 btn_compare_preview" id="" type="button"><i class="ci-compare fs-lg me-2"></i>Compare</button>
                      </div>
                    </div>
                    ...
                    <ul class="fs-sm pb-2">
                    <li><span class="text-muted">Categiory: <span class="quick-view-categiory"></span></li>
                    <li><span class="text-muted">Brand: </span><span class="quick-view-brand"></span></li>
                    <a href="" class="view_more_product">See more ></a>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div class="topbar topbar-dark bg-primary">
          <div class="container">
            <div>
              ...
              <div class="topbar-text text-nowrap d-none d-md-inline-block border-start border-light ps-3 ms-3"><span class="text-muted me-1">Available 24/7 at</span><a class="topbar-link customer_care_link" href=""><span class="customer_care"></span></a></div>
            </div>
            <div class="topbar-text dropdown d-md-none ms-auto"><a class="topbar-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Wishlist / Compare / Track</a>
              <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="account-wishlist.php"><i class="ci-heart text-muted me-2"></i>Wishlist (<span class="account-wishlist-count"></span>)</a></li>
                <li><a class="dropdown-item" href="comparison.php"><i class="ci-compare text-muted me-2"></i>Compare (<span class="account-compare-count"></span>)</a></li>
                <li><a class="dropdown-item" href="order-tracking.php"><i class="ci-location text-muted me-2"></i>Order tracking</a></li>
              </ul>
            </div>
            <div class="d-none d-md-block ms-3 text-nowrap"><a class="topbar-link d-none d-md-inline-block" href="account-wishlist.php"><i class="ci-heart mt-n1"></i>Wishlist (<span class="account-wishlist-count"></span>)</a><a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="comparison.php"><i class="ci-compare mt-n1"></i>Compare (<span class="account-compare-count"></span>)</a><a class="topbar-link ms-3 border-start border-light ps-3 d-none d-md-inline-block" href="order-tracking.php"><i class="ci-location mt-n1"></i>Order tracking</a></div>
          </div>
        </div>
          ...
          <div class="navbar navbar-expand-lg navbar-light">
            <div class="container"><a class="navbar-brand d-none d-sm-block me-3 flex-shrink-0" href="index.php"><img src="img/about/logo.png" width="100" alt="Infinite slot"></a><a class="navbar-brand d-sm-none me-2" href="index.html"><img src="img/about/logo.png" width="74" alt="Infinite slot"></a>
              ...
              <div class="input-group d-none d-lg-flex flex-nowrap mx-4"><i class="ci-search position-absolute top-50 start-0 translate-middle-y ms-3"></i>
                <input class="form-control rounded-start w-100 searchInput" type="text" placeholder="Search for products">
              ...
              <div class="table-responsive" data-simplebar>
                <div class="d-flex d-xl-block"><a class="d-flex align-items-center bg-faded-info rounded-3 pt-2 ps-2 mb-4 me-4 me-xl-0" href="#" style="min-width: 16rem;"><img src="img/home/banners/banner-sm01.png" width="125" alt="Banner">
                    <div class="py-4 px-2">
                      ...
                      <div class="text-info fs-sm" id="btn_shope">Shop now<i class="ci-arrow-right fs-xs ms-1"></i></div>
      ...
      <section class="container pt-5">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
          ...
          <div class="pt-3"><a class="btn btn-outline-accent btn-sm" href="shop.php">More products<i class="ci-arrow-right ms-1 me-n1"></i></a></div>
        </div>
        <!-- Grid-->
        <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3" id="view_products">
        </div>
      </section>
    ...
    <div class="handheld-toolbar">
      <div class="d-table table-layout-fixed w-100"><a class="d-table-cell handheld-toolbar-item" href="index.php"><span class="handheld-toolbar-icon"><i class="ci-home"></i></span><span class="handheld-toolbar-label">Home</span></a><a class="d-table-cell handheld-toolbar-item" href="shop.php"><span class="handheld-toolbar-icon"><i class="ci-store"></i></span><span class="handheld-toolbar-label">Shop</span></a><a class="d-table-cell handheld-toolbar-item" href="shop-cart.php"><span class="handheld-toolbar-icon"><i class="ci-bag"></i><span class="badge bg-primary rounded-pill ms-1 cart_counts"></span></span><span class="handheld-toolbar-label cart_prices"></span></a><a class="d-table-cell handheld-toolbar-item" href="account-wishlist.php"><span class="handheld-toolbar-icon"><i class="ci-heart"></i></span><span class="handheld-toolbar-label">Wishlist</span></a></div>
    </div>
...
<!-- Mirrored from cartzilla.createx.studio/home-electronics-store.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:40:07 GMT -->
