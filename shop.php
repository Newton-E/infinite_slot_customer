...
<!-- Mirrored from cartzilla.createx.studio/shop-grid-ls.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:40:49 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->

<head>
  <meta charset="utf-8">
  <title>Infinite Slots | Shopping page</title>
  <!-- SEO Meta Tags-->
  <meta name="description" content="Infinite - Bootstrap E-commerce Template">
  ...
  <div class="modal fade" id="signin-modal" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <input type="hidden" value="true" class="scroll_status">
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title product-title"><a href="shop-single.php?product=" data-bs-toggle="tooltip" data-bs-placement="right" title="Go to product page" id="productName"><i class="ci-arrow-right fs-lg ms-2"></i></a><input type="hidden" id="productid" /></h4>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
              ...
              <div class="col-lg-5 pt-4 pt-lg-0 image-zoom-pane">
                <div class="product-details ms-auto pb-3">
                  ...
                  <div class="position-relative me-n4 mb-3 ">
                    <div class="product-badge product-available mt-n1"><i class="ci-security-check"></i><span class="product-badge-text">Product available</span></div>
                  </div>
                  <div class="d-flex align-items-center pt-2 pb-4">
                    <!-- <select class="form-select me-3 preview-product-qty" style="width: 5rem;">
                    ...
                    <input type="number" style="width: 5rem" placeholder="Quantity" class="form-input me-3 preview-product-qty" min-value="1"/>
                    <button class="btn btn-primary btn-shadow d-block w-100 btn_add-cart_preview btn_add_cart" id="" type="button"><i class="ci-cart fs-lg me-2"></i>Add to Cart</button>
                  </div>
                  <div class="d-flex mb-4">
                    <div class="w-100 me-3">
                      <button class="btn btn-secondary d-block w-100 btn_add_wishlist-preview" id="" type="button"><i class="ci-heart fs-lg me-2"></i><span class='d-none d-sm-inline'>Add to </span>Wishlist</button>
                    </div>
                    <div class="w-100">
                  ...
                  <ul class="fs-sm pb-2">
                    <li><span class="text-muted">Categiory: </span class="quick-view-categiory"></li>
        ...
        <aside class="col-lg-4">
          ...
          <div class="offcanvas offcanvas-collapse bg-white w-100 rounded-3 shadow-lg py-1" id="shop-sidebar" style="max-width: 22rem;">
            ...
            <div class="offcanvas-body py-grid-gutter px-lg-grid-gutter">
              ...
              <!-- Filter by Brand-->
              <div class="widget widget-filter mb-4 pb-4 border-bottom brand_category">
                
                <!-- <div id="brand_category"></div> -->
              </div>
              <!-- Filter by Size-->
          ...
          <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
            <div class="d-flex flex-wrap">
              <div class="d-flex align-items-center flex-nowrap me-3 me-sm-4 pb-3">
                ...
                <select class="form-select" id="shop_sorting">
                  <option value="popular">Popularity</option>
                  <option value="price_low">Low - Hight Price</option>
                  <option value="price_high">High - Low Price</option>
                  <option value="rating">Average Rating</option>
                  <option value="alphabet_az">A - Z Order</option>
                  <option value="alphabet_za">Z - A Order</option>
                </select>
              </div>
            </div>
            ...
            <div class="d-none d-sm-flex pb-3"><a class="btn btn-icon nav-link-style bg-light text-dark disabled opacity-100 me-2" href="#"><i class="ci-view-grid"></i></a><a class="btn btn-icon nav-link-style nav-link-light" href="shop-list.php"><i class="ci-view-list"></i></a></div>
          </div>
          <!-- Products grid-->
...
<!-- Mirrored from cartzilla.createx.studio/shop-grid-ls.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:40:51 GMT -->
