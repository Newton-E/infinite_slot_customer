...
<head>
    <meta charset="utf-8">
    <title>Infinite Shopping | Home page</title>
    <!-- SEO Meta Tags-->
      ...
      <div class="container py-4 py-lg-5 my-4">
        <div class="row">
            ...
            <div class="card border-0 shadow">
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <input class="form-control rounded-start" type="email" id="user_email" name="user_email" placeholder="Email" required>
                </div>
                <div class="input-group mb-3">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                  ...
                  <a class="nav-link-inline fs-sm" href="account-password-recovery.php">Forgot password?</a>
                </div>
                <hr class="mt-4">
          ...
          <div class="col-md-6 pt-4 mt-3 mt-md-0">
            ...
            <form class="needs-validation" id="form_register" novalidate>
              <div class="row gx-4 gy-3">
                <div class="col-sm-12">
                  <label class="form-label" for="reg-fn">Full Name</label>
                  <input class="form-control" type="text" required id="reg_fn">
                  <div class="invalid-feedback">Please enter your first name!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" for="reg-email">E-mail Address</label>
                  <input class="form-control" type="email" required id="reg_email">
                  <div class="invalid-feedback">Please enter valid email address!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" for="reg-phone">Phone Number</label>
                  <input class="form-control" type="text" required id="reg_phone">
                  <div class="invalid-feedback">Please enter your phone number!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" for="reg-password">Password</label>
                  <input class="form-control" type="password" required id="reg_password">
                  <div class="invalid-feedback">Please enter password!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" for="reg-password-confirm">Confirm Password</label>
                  <input class="form-control" type="password" required id="reg_password_confirm">
                  <div class="invalid-feedback">Passwords do not match!</div>
                </div>
                <div class="col-12 text-end">
                  <button class="btn btn-primary" type="submit" id="btn_reg"><i class="ci-user me-2 ms-n1"></i>Sign Up</button>
                </div>
              </div>
            </form>
          </div>
