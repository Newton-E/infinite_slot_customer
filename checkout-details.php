...
<!-- Mirrored from cartzilla.createx.studio/checkout-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:08 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Infinite Shopping | Checkout page</title>
    <!-- SEO Meta Tags-->
          ...
          <section class="col-lg-8">
            ...
            <div class="steps steps-light pt-2 pb-3 mb-5">
              <a class="step-item active" href="shop-cart.php">
                ...
                <a class="step-item active current" href="checkout-details.php">
                <div class="step-progress"><span class="step-count">2</span></div>
                <div class="step-label"><i class="ci-user-circle"></i>Details</div>
              </a>
              <a class="step-item proceed-to-shipping" href="#">
            ...
            <div class="d-sm-flex justify-content-between align-items-center bg-secondary p-4 rounded-3 mb-grid-gutter">
              <div class="d-flex align-items-center">
                <div class="img-thumbnail rounded-circle position-relative flex-shrink-0"><span class="badge bg-warning position-absolute end-0 mt-n2 user_points" data-bs-toggle="tooltip" title="Reward points">384</span><img class="rounded-circle" src="img/shop/account/avatar.jpg" width="90" alt="Susan Gardner"></div>
                <div class="ps-3">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="mb-3">
                  ...
                  <input class="form-control" id="account-fullname" type="text" disabled>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-3">
                  ...
                  <select class="form-select" id="checkout-state">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="mb-3">
                  ...
                  <select class="form-control" type="text" id="checkout-address"></select>
                </div>
              </div>
            </div>
            ...
            <div class="d-none d-lg-flex pt-4 mt-3">
              ...
              <div class="w-50 ps-2"><button class="btn btn-primary d-block w-100 proceed-to-shipping" id="proceed-to-shipping"><span class="d-none d-sm-inline">Proceed to Shipping</span><span class="d-inline d-sm-none">Next</span><i class="ci-arrow-right mt-sm-0 ms-1"></i></button></div>
            </div>
          </section>
          <!-- Sidebar-->
...
<!-- Mirrored from cartzilla.createx.studio/checkout-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:09 GMT -->
</html>