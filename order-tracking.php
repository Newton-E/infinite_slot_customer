...
<!-- Mirrored from cartzilla.createx.studio/order-tracking.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:09 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Cartzilla | Tracking order: <span class="h4 fw-normal text-light">34VB5540K83</span></title>
    <!-- SEO Meta Tags-->
      ...
      <div class="bg-primary py-4">
        <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
          ...
          <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
            <h1 class="h3 text-light mb-0">Tracking order: <span class="h4 fw-normal text-light order_number"></span></h1>
          </div>
        </div>
      </div>
      <div class="container py-5 mb-2 mb-md-3">
        <!-- Details-->
        <div class="row gx-4 mb-4" id="order_tracking_header">
          
        </div>
        <!-- Progress-->
        <div class="card border-0 shadow-lg">
          <div class="card-body pb-2" id="order_tracking_details">
