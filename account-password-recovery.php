        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-10">
            ...
            <div class="card py-2 mt-4">
              <form class="card-body needs-validation" id="form_recovery" novalidate>
                <div class="mb-3">
                  <label class="form-label" for="recover-email">Enter your email address</label>
                  <input class="form-control" type="email" id="recover_email" required>
                  <div class="invalid-feedback">Please provide valid email address.</div>
                </div>
                <button class="btn btn-primary" type="submit" id="btn_recover">Get new password</button>
              </form>
            </div>
          </div>
        </div>
