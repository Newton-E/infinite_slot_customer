...
<!-- Mirrored from cartzilla.createx.studio/account-address.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:10 GMT -->
  ...
  <body class="handheld-toolbar-enabled">
    ...
    <main class="page-wrapper">
            ...
            <div class="modal-body">
              <div class="row gx-4 gy-3">
                <div class="col-sm-12">
                  ...
                  <textarea class="form-control" type="text" id="newaddress" required></textarea>
                  <div class="invalid-feedback">Please provide the address</div>
                </div>
              </div>
            </div>
            <div class="modal-footer">
              <button class="btn btn-secondary add-new-address-close" type="button" data-bs-dismiss="modal">Close</button>
              <button class="btn btn-primary btn-shadow add-new-address" type="submit">Add address</button>
            </div>
          </div>
        </div>
      </form>
      ...
      <div class="container pb-5 mb-2 mb-md-4">
        <div class="row">
          <!-- Sidebar-->
          <aside class="col-lg-4 pt-4 pt-lg-0 pe-xl-8">
          ...
          <section class="col-lg-8">
            ...
            <div class="table-responsive fs-md">
              <table class="table table-hover mb-0">
                ...
                <tbody class="registered_addresses">
