...
<!-- Mirrored from cartzilla.createx.studio/shop-list-ls.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:40:51 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Cartzilla | Shop list left sidebar</title>
    <!-- SEO Meta Tags-->
            ...
            <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
              <div class="d-flex flex-wrap">
                <div class="d-flex align-items-center flex-nowrap me-3 me-sm-4 pb-3">
                  ...
                  <select class="form-select" id="shop_list_sorting">
              ...
              <div class="d-none d-sm-flex pb-3"><a class="btn btn-icon nav-link-style nav-link-light me-2" href="shop.php"><i class="ci-view-grid"></i></a><a class="btn btn-icon nav-link-style bg-light text-dark disabled opacity-100" href="#"><i class="ci-view-list"></i></a></div>
            </div>
            <!-- Products list-->
            <!-- Product-->
