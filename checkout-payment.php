...
<!-- Mirrored from cartzilla.createx.studio/checkout-shipping.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:09 GMT -->
<!-- Added by HTTrack -->
          ...
          <section class="col-lg-8">
            ...
            <div class="accordion mb-2" id="payment-method">
              <div class="accordion-item">
                <h3 class="accordion-header"><a class="accordion-button" href="#card" data-bs-toggle="collapse"><i class="ci-card fs-lg me-2 mt-n1 align-middle"></i>Pay with Credit Card <span class="fs-sm text-danger">  Our card payment is not active yet</span></a></h3>
                <div class="accordion-collapse collapse" id="card" data-bs-parent="#payment-method">
                  <div class="accordion-body">
                    <p class="fs-sm">We accept following credit cards:&nbsp;&nbsp;<img class="d-inline-block align-middle" src="img/cards.png" width="30" alt="Cerdit Cards"></p>
              ...
              <div class="accordion-header d-flex justify-content-between align-items-center p-3">
                <div>
                  <img src="img/paystack.256x252.png" class="me-2 align-middle" width="20" alt="">
                  Pay with PayStack
                </div>
                <input type="radio" name="payment-method" id="paystack-option" class="align-middle">
              </div>
              </div>
              <div class="accordion-item">
              <div class="accordion-header d-flex justify-content-between align-items-center p-3">
                <div>
                <img src="img/flutterwave.256x48.png" class="me-2 align-middle" width="50" alt="">Pay with flutterwave
                </div>
                <input type="radio" name="payment-method" id="flutterwave-option" class="align-middle">
              </div>
              </div>
            </div>
            <!-- Navigation (desktop)-->
            <div class="d-none d-lg-flex pt-4">
              ...
              <div class="w-50 ps-2"><a class="btn btn-primary d-block w-100" id="checkout-review" href="#"><span class="d-none d-sm-inline">Review your order</span><span class="d-inline d-sm-none">Review order</span><i class="ci-arrow-right mt-sm-0 ms-1"></i></a></div>
            </div>
          </section>
          <!-- Sidebar-->
