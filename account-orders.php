...
<!-- Mirrored from cartzilla.createx.studio/account-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 22:41:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Cartzilla | My orders</title>
    <!-- SEO Meta Tags-->
        ...
        <aside class="col-lg-4 pt-4 pt-lg-0 pe-xl-8">
            <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
                ...
                <div class="d-lg-block collapse" id="account-menu">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-orders.php"><i class="ci-bag opacity-60 me-2"></i>Orders<span class="fs-sm text-muted ms-auto" id="account-order-count">0</span></a></li>
          ...
          <section class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
              ...
              </div><a class="btn btn-primary btn-sm d-none d-lg-inline-block btn_logout" href="#"><i class="ci-sign-out me-2"></i>Sign out</a>
            </div>
            <!-- Orders list-->
